    ...
    subsections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          '셋째, 인권 기반 접근이다. 플로리디(Floridi, 2023) 등이 주장하는 것으로, AI 시대의 관계를 새로운 권리 체계로 구성하자는 것이다 — 데이터에 대한 자기결정권, 알고리즘 의사결정에 대한 설명을 요구할 권리, 중요한 결정에서 인간의 심의를 받을 권리. EU GDPR 제22조는 이미 "자동화된 의사결정의 대상이 되지 않을 권리"를 규정했다. 방향은 옳지만 두 가지 한계가 있다 — 권리가 선언되어도 그것을 실현할 제도적 메커니즘이 부족하고, 권리 간 충돌(예: 설명 가능성 요구와 영업비밀 보호)을 조정할 원칙이 불분명하다.',
